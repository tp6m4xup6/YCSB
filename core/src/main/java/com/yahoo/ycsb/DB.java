...
public abstract class DB {
     ...
     * @param familyFieldMaps The list of fields to read, or null for all of
     * them
     * @param result A HashMap of field/value pairs for the result
     * @return The result of the operation.
     */
    public abstract Status read(String table, String key, HashMap<String, Set<String>> familyFieldMaps,  HashMap<String,ByteIterator> result);
     ...
     * @return The result of the operation.
     */
    public abstract Status scan(String table, String startkey, int recordcount, HashMap<String,Set<String>> familyFieldMap,Vector<HashMap<String,ByteIterator>> result);
...
//	public abstract Status update(String table, String key,String family, HashMap<String,ByteIterator> values);
    public abstract Status update(String table, String key, HashMap<String, HashMap<String, ByteIterator>> familyValuesMap);
...
//	public abstract Status insert(String table, String key,String family, HashMap<String,ByteIterator> values);
    public abstract Status insert(String table, String key, HashMap<String, HashMap<String, ByteIterator>> familyValuesMap);
...
//	//由對一個family的多個field做讀取，改成對多個family的多個field做讀取
//	public abstract Status read(String table, String key, Set<String> fields, HashMap<String,ByteIterator> result);
//	public abstract Status read(String table, String key, HashMap<String,Set<String>> familyFieldMap, HashMap<String,HashMap<String,ByteIterator>> familyFieldResult);
//
//	//由對一個family的多個field做寫入，改成對多個family的多個field做寫入
//    public abstract Status insert(String table, String key, HashMap<String,ByteIterator> values);
//    public abstract Status insert(String table, String key, HashMap<String,HashMap<String,ByteIterator>> familyValuesMap);
//        
//	//由對一個family的多個field做更新，改成對多個family的多個field做更新，同insert
//	public abstract Status update(String table, String key, HashMap<String,ByteIterator> values);
//    public abstract Status update(String table, String key, HashMap<String,HashMap<String,ByteIterator>> familyValuesMap);
//        
//	//由對一個family的多個field做掃描，改成對多個family的某些field做掃描
...
//    public abstract Status scan(String table, String startkey, int recordcount, HashMap<String,Set<String>> familyFieldMap, HashMap<String,HashMap<String,ByteIterator>> familyFieldResult);
//		
//    //由刪除key的所有值，改成對多個family的多個field做刪除
//    public abstract Status delete(String table, String key);
//	public abstract Status delete(String table, String key ,HashMap<String,Set<String>> familyFieldMap;
}
